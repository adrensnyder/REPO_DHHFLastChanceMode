...
namespace DHHFLastChanceMode.Modules.Config
{
    internal static class ConfigMetadata
    {
        ...
        internal static readonly IReadOnlyList<EntryDefinition> FeatureFlagEntries = new EntryDefinition[]
        {
            ...
            new IntEntryDefinition(FeatureFlags.Sections.LastChanceQuick, nameof(FeatureFlags.LastChanceConsolationMoney), FeatureFlags.Descriptions.LastChanceConsolationMoney, 0, 5, () => FeatureFlags.LastChanceConsolationMoney, value => FeatureFlags.LastChanceConsolationMoney = value),
