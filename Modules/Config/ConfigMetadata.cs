...
namespace DHHFLastChanceMode.Modules.Config
{
    internal static class ConfigMetadata
    {
        ...
        internal static readonly IReadOnlyList<EntryDefinition> FeatureFlagEntries = new EntryDefinition[]
        {
            ...
            new IntEntryDefinition(FeatureFlags.Sections.LastChanceQuick, nameof(FeatureFlags.LastChanceDynamicMaxMinutes), FeatureFlags.Descriptions.LastChanceDynamicMaxMinutes, 5, 20, () => FeatureFlags.LastChanceDynamicMaxMinutes, value => FeatureFlags.LastChanceDynamicMaxMinutes = value),
            new IntEntryDefinition(FeatureFlags.Sections.LastChanceQuick, nameof(FeatureFlags.LastChanceDynamicMaxMinutesAtLevel), FeatureFlags.Descriptions.LastChanceDynamicMaxMinutesAtLevel, 5, 60, () => FeatureFlags.LastChanceDynamicMaxMinutesAtLevel, value => FeatureFlags.LastChanceDynamicMaxMinutesAtLevel = value),
            ...
            new IntEntryDefinition(FeatureFlags.Sections.LastChanceExtraction, nameof(FeatureFlags.LastChanceConsolationMoney), FeatureFlags.Descriptions.LastChanceConsolationMoney, 0, 5, () => FeatureFlags.LastChanceConsolationMoney, value => FeatureFlags.LastChanceConsolationMoney = value,
                aliases: new[] { new ConfigMetadata.AliasDefinition(FeatureFlags.Sections.LastChanceQuick, nameof(FeatureFlags.LastChanceConsolationMoney)) }),
            ...
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceTimer, nameof(FeatureFlags.LastChanceTimerPerMonsterSeconds), FeatureFlags.Descriptions.LastChanceTimerPerMonsterSeconds, 0f, 60f, () => FeatureFlags.LastChanceTimerPerMonsterSeconds, value => FeatureFlags.LastChanceTimerPerMonsterSeconds = value),
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceTimer, nameof(FeatureFlags.LastChanceTimerPerRequiredPlayerSeconds), FeatureFlags.Descriptions.LastChanceTimerPerRequiredPlayerSeconds, 0f, 120f, () => FeatureFlags.LastChanceTimerPerRequiredPlayerSeconds, value => FeatureFlags.LastChanceTimerPerRequiredPlayerSeconds = value),
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceTimer, nameof(FeatureFlags.LastChanceLevelContextRoomWeight), FeatureFlags.Descriptions.LastChanceLevelContextRoomWeight, 0f, 3f, () => FeatureFlags.LastChanceLevelContextRoomWeight, value => FeatureFlags.LastChanceLevelContextRoomWeight = value),
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceTimer, nameof(FeatureFlags.LastChanceLevelContextMonsterWeight), FeatureFlags.Descriptions.LastChanceLevelContextMonsterWeight, 0f, 3f, () => FeatureFlags.LastChanceLevelContextMonsterWeight, value => FeatureFlags.LastChanceLevelContextMonsterWeight = value),
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceTimer, nameof(FeatureFlags.LastChanceTimerPerFarthestMeterSeconds), FeatureFlags.Descriptions.LastChanceTimerPerFarthestMeterSeconds, 0f, 20f, () => FeatureFlags.LastChanceTimerPerFarthestMeterSeconds, value => FeatureFlags.LastChanceTimerPerFarthestMeterSeconds = value),
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceTimer, nameof(FeatureFlags.LastChanceTimerPerRoomStepSeconds), FeatureFlags.Descriptions.LastChanceTimerPerRoomStepSeconds, 0f, 60f, () => FeatureFlags.LastChanceTimerPerRoomStepSeconds, value => FeatureFlags.LastChanceTimerPerRoomStepSeconds = value),
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceTimer, nameof(FeatureFlags.LastChanceTimerPerBelowTruckPlayerSeconds), FeatureFlags.Descriptions.LastChanceTimerPerBelowTruckPlayerSeconds, 0f, 120f, () => FeatureFlags.LastChanceTimerPerBelowTruckPlayerSeconds, value => FeatureFlags.LastChanceTimerPerBelowTruckPlayerSeconds = value),
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceTimer, nameof(FeatureFlags.LastChanceTimerPerBelowTruckMeterSeconds), FeatureFlags.Descriptions.LastChanceTimerPerBelowTruckMeterSeconds, 0f, 30f, () => FeatureFlags.LastChanceTimerPerBelowTruckMeterSeconds, value => FeatureFlags.LastChanceTimerPerBelowTruckMeterSeconds = value),
            ...
            new FloatEntryDefinition(FeatureFlags.Sections.LastChanceGameplay, nameof(FeatureFlags.LastChanceIndicatorDirectionPenaltyMinSeconds), FeatureFlags.Descriptions.LastChanceIndicatorDirectionPenaltyMinSeconds, 0f, 60f, () => FeatureFlags.LastChanceIndicatorDirectionPenaltyMinSeconds, value => FeatureFlags.LastChanceIndicatorDirectionPenaltyMinSeconds = value),
